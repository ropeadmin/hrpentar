          ...
          <div className="">
            ...
            <div className='bg-white mx-auto w-full min-h-screen px-28 flex flex-col justify-center items-center'>
                ...
                <div className="w-full flex flex-col justify-center items-center text-center">
                    ...
                    <div className="mt-7">
                        <h1 className="text-[#0f1625] text-[28px]  font-bold font-['Cabinet Grotesk'] leading-loose">Password reset done</h1>
                        <div className="text-center"><span className="text-[#0f1625] text-base font-normal font-['Cabinet Grotesk'] leading-tight">Your password has been reset, log in to continue.</span></div>
                    </div>
                </div>
