import { useEffect, useRef, useState, JSX, FC } from 'react';
...
const AutoSwipingCarousel: FC<AutoSwipingCarouselProps> = ({
  designTab,
  changeTabHandler,
}) => {
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            >
              <path
                ...
                strokeWidth="2"
                d="M3 3h2l.6 2.4L7 8h10l1.4-2.4L21 3h2M4 6h16l1.2 6H5.8L4 6zM6 21a2 2 0 100-4 2 2 0 000 4zm12 0a2 2 0 100-4 2 2 0 000 4z"
              />
            </svg>
          </div>
        </div>
  ...
  return (
    <div className="relative overflow-hidden w-full h-auto">
      <div ref={carouselRef} className="flex gap-7">
        {items}
      </div>
    </div>
  );
