...
export default function Company() {
  ...
  const [openTemplateAttentionModal, setOpenTemplateAttentionModal] =
    useState(false);
  const { data: getForms, isLoading: isFormLoading } = useGetFormQuery();
  const { data: fetchTemplateData, isLoading: isTemplateLoading } =
    useGetTemplateQuery();
  ...
  return (
    <div>
                ...
                <div className="flex flex-col justify-center items-center text-center h-[300px] ">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-[16px] font-[400] text-[#323B49] mt-2">
                      Setup onboarding templates for new hires.
                      <br />
                  ...
                  <Button
                    ...
                    onClick={handleTemplateAttentionOpen}
                  >
              ...
              {getForms && getForms?.data?.length > 0 ? (
                ...
                <div className="flex flex-col justify-center items-center text-center h-[300px] ">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-[16px] font-[400] text-[#323B49] mt-2">
                      Build forms by creating contents.
                      <br />
                  ...
                  <Button
                    className="mt-5 rounded-lg"
                    onClick={handleOpenFormBuilerOption}
                  >
      ...
      <Dialog
        open={openTemplateAttentionModal}
        onOpenChange={setOpenTemplateAttentionModal}
      >
        ...
        <DialogContent className="max-w-[544px] top-[30%]">
          <DialogHeader>
            ...
            <DialogDescription className="text-n900 text-sm">
              You do not have any forms yet to create a template. Please go to
              form builder to create form and customize templates.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="mt-4">
            ...
            <Button type="submit" onClick={handleOpenFormBuilerOption}>
              Go to form builder
            </Button>
          </DialogFooter>
        </DialogContent>
              ...
              <Link href={'/dashboard/teams/onboarding/form_builder'}>
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-n900 text-base font-normal">
                      Build form and questions manually
                    </p>
                  </div>
                </div>
              </Link>
              ...
              <Link href={''}>
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-n900 text-base font-normal">
                      Paste questions or import Google Form
                    </p>
                  </div>
                </div>
              </Link>
