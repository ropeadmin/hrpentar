  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        active:
          "border-transparent bg-g200 text-g800 hover:bg-g800/80",
        outline: "text-foreground",
        pending:
          "border-transparent bg-y100 text-y900 hover:bg-y100/80",
        overdue:
        "border-transparent bg-r100 text-r800 hover:bg-r100/80",
