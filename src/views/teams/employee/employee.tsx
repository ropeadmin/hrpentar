...
import { useGetEmployeesQuery } from '@/store/features/employee/employeeService';
...
const Employees = () => {
  ...
  const { isLoading, data: getAllEmployees } = useGetEmployeesQuery();
              ...
              <div className="w-full">
                ...
                <div className="w-full mt-8 flex items-center justify-between">
                  <div className="w-[242px] h-[212px] p-4 bg-n75 hover:bg-r200/60 border border-n300 hover:border-r600 rounded-lg flex items-center">
                    <Link href={'/dashboard/teams/employee/add-employee'}>
