                  ...
                  <div {...provided.droppableProps} ref={provided.innerRef}>
                    ...
                    <div ref={provided.innerRef} {...provided.droppableProps}>
                      {section.inputs.map((input, inputIndex) => (
                        <Draggable key={input.id} draggableId={input.id} index={inputIndex}>  
                          {(provided, snapshot) => (
                            <Card
                              className={cn("w-full mb-6 border border-n200",
                            ...
                            >
                                ...
                                <div>
                                  <div className="flex items-center space-x-5 cursor-pointer">
                                    <BootstrapTooltip title="Add Section" placement="bottom" sx={{ color: "#FFFFFF",  }}>
                                      <StretchHorizontal color="#687588" size={20} onClick={() => addNewSection()}  />
                                    </BootstrapTooltip>
                              ...
                              <CardContent className="w-full  p-5 flex items-center">
                                  <div className="w-10">
                                    <GripVertical strokeWidth={1.4} className="text-n900"/>
                                  </div>
                                  {
                                    input.type === "email" &&  (
                                      <div className="grid grid-cols-2 w-full gap-4 ">
