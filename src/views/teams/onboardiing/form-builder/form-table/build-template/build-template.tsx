...
import { FormApiResponseType, FormDataType } from "@/store/features/form-builder/type"
...
const FormSchema = z.object({
  name: z.string().nonempty({ message: "Please select a form title" }),
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <FormField
              ...
              name="forms"
              render={() => (
                <FormItem className="grid grid-cols-2 gap-y-4 mt-4">
